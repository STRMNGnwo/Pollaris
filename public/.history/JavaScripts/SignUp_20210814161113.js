...
function signUp()
{
  ...
  var firstHttp= new XMLHttpRequest();
   ...
   //details needed by firebase to create a user
    ...
    firstHttp.open("POST","https://us-central1-formsbackendtrial.cloudfunctions.net/user-checkUsername");
          ...
          firebase.auth().createUserWithEmailAndPassword(email, password).then((userCredential) => {      
            // Signed in          
              var user = userCredential.user;          
                ...
                http.open("POST","https://us-central1-formsbackendtrial.cloudfunctions.net/user-addUser");
