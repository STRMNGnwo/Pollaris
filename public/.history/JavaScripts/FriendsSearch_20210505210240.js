...
function friendsSearch()
{
    ...
    http.open("GET","https://us-central1-formsbackendtrial.cloudfunctions.net/searchUsers"+"?username="+searchName);
    http.onreadystatechange=function()
    {
        ...
        if(http.readyState===DONE)
        {
            if(http.status===OK)
            {
                ...
                checkhttp.open("GET","https://us-central1-formsbackendtrial.cloudfunctions.net/checkFriends"+"?userID="+userID+"&checkID="+checkID);
...
function showNotification()
{
    firebase.auth().onAuthStateChanged(function(user) 
    {
        ...
        {
            var http = new XMLHttpRequest();
            http.open('GET','https://us-central1-formsbackendtrial.cloudfunctions.net/getNotification'+"?uid="+user.uid);
            http.onreadystatechange = function()
            {
                var OK = 200;
                var DONE = 4;
...
function sendFriendRequest(){
    firebase.auth().onAuthStateChanged(function(user) {
        if (user) {
            ...
            var HTTP = new XMLHttpRequest();
            HTTP.open('PUT','https://us-central1-formsbackendtrial.cloudfunctions.net/createNotification');
...
{
    var http = new XMLHttpRequest();
    http.open('POST',"https://us-central1-formsbackendtrial.cloudfunctions.net/acceptRequest");
    http.setRequestHeader("Content-Type","application/json");
    var objToSend = 
    {
        requestID:requestID,
...
function denyRequest(requestID,senderID, recieverID, divID)
  {
    var http = new XMLHttpRequest();
    http.open('POST',"https://us-central1-formsbackendtrial.cloudfunctions.net/denyRequest");
    http.setRequestHeader("Content-Type","application/json");
    var objToSend = {
      senderID:senderID,
      requestID:requestID,
...
function showFriends()
{
    ...
    http.open("GET","https://us-central1-formsbackendtrial.cloudfunctions.net/getMyFriends"+"?uid="+userID);
...
function getFriendProfile(username)
{
    ...
    if(searchName!=undefined&&!searchName.trim())
    {
        ...
        http.open("GET","https://us-central1-formsbackendtrial.cloudfunctions.net/getMyFriends"+"?username="+searchName);
...
function unfriend()
{
    ...
    http.open("POST","https://us-central1-formsbackendtrial.cloudfunctions.net/unfriend");
