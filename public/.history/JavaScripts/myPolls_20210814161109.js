function showPrivatePolls()
{
 ...
 if(currentUser!=null)
 {
  ...
  http.open("GET","https://us-central1-formsbackendtrial.cloudfunctions.net/user-getMyPrivatePolls"+"?uid="+userID);
...
function showPublicPolls() //used to show public polls
{
    ...
    if(currentUser!=null)
    {
        ...
        http.open("GET","https://us-central1-formsbackendtrial.cloudfunctions.net/user-getMyPublicPolls"+"?uid="+userID);
   ...
   var currentUser=firebase.auth().currentUser;
    var http= new XMLHttpRequest();
     ...
     if(publicPoll===true) // triple equals is used to ensure that the variables have the same values and same datatype.
     {
       ...
       http.open("GET","https://us-central1-formsbackendtrial.cloudfunctions.net/polls-searchPublicPolls"+"?pollid="+pollID) //params for query string should be poll id and current user id.
     ...
     else if(publicPoll===false)
     {
      ...
      http.open("GET","https://us-central1-formsbackendtrial.cloudfunctions.net/polls-searchPrivatePolls"+privatePollQueryString) //params for query string should be poll id and current user id.
     }
...
function addVotes(integer,id,isPriv,creatorUserID)//this function should be called when a vote is made and  has to be updated in the database.
{
  ...
  http.open("PUT","https://us-central1-formsbackendtrial.cloudfunctions.net/polls-updateVotes") //appending  query string to url
