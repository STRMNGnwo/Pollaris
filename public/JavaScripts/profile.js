             ...
             firebase.auth().onAuthStateChanged((user)=>
             {
               if(user.emailVerified!=false)
               {
                 if(user)
                 {
                    ...
                    http.open("GET","https://us-central1-formsbackendtrial.cloudfunctions.net/getProfileData"+"?id="+id);
...
function updateProfile()
{
  ...
  if((newName.trim() && newName!=undefined && newName!=null) &&(newBio.trim() && newBio!=undefined && newBio!=null))
  {
    ...
    http.open("POST","https://us-central1-formsbackendtrial.cloudfunctions.net/updateProfile");
