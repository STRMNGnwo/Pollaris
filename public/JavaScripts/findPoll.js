...
if(currentUser != null)
{
  ...
  console.log(userID);
      ...
      http.open("GET","https://us-central1-formsbackendtrial.cloudfunctions.net/polls-getdata"+"?latitude="+location.latitude+"&longitude="+location.longitude+"&userID="+userID)
